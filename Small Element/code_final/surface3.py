...
def extract():
	with open('small_element_sur_3.node') as f:
		f.readline()
		node=[]
		triangle=[]
		count=0
...
def isPresent():
	...
	# cc=[[-24.3822881665,177.902715325,-239.712083678]]
	btm=create()
	# with open("debug3.1","w") as wt:
	# 	with open("debug_miss3.1","w") as wt2:
	with open("output_surface3.2","w") as wt:	
		with open("missed_surface3.2","w") as wt2:	
			for i in cc:
				dist_list=[]
				dist_list2=[]
				for bt in btm:
